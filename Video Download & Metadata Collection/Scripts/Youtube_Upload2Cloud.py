...
# type in command line prompt (include bucket_name)
# python Youtube_Upload2Cloud.py --bucket_name videos_final

# creating environment variable for google app credentials 
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="stoked-dominion-341317-9c94dcd96845.json"
